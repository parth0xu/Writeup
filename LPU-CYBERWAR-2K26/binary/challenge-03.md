...
- Category: `binary`
- Source: `LPU-CYBERWAR-2K26/Writeups.txt` line 767
- Final Flag: `flag{https://www.quickheal.com}`
...
```text
python3 exploit.py 185.188.249.142 5555
challenge 1 : flag{https://www.quickheal.com}
flag{C:\dr0pp3d.bat}
Flag format: flag{}
```
